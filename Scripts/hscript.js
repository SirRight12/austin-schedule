...
function updateDay() {
    if (plcDates.includes(dateText)) {
        ...
        case 4:
        case 5:
        // Remove these later (testing purposes)
        case 6:
        case 0:
            console.log(schedules['mtwthf'])
            timeDict = schedules["mtwthf"];
            break;    
        default:
...
function periodText(inp) {
    switch (inp) {
        ...
        //Default case
        default:
        return "What the heck is this period? " + inp;
    }
}
